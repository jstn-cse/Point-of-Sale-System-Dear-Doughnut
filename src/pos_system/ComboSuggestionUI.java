...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(232,240,214));
            }
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(232,240,214));
            }
        ...
        txt.setForeground(new Color(232,240,214));
        txt.setBackground(new Color(89,56,46));
        txt.setBorder(new EmptyBorder(0, 4, 0, 4));
        comboBox.setBackground(new Color(89,56,46));
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (i >= 0) {
                    ...
                    label.setBackground(new Color(89,56,46));
                    label.setForeground(new Color(232,240,214));
                } else {
                    label.setBorder(null);
                }
                if (bln) {
                    label.setOpaque(true);
                    label.setBackground(new Color(108,68,56));
                    label.setForeground(new Color(232,240,214));
                }
                return label;
            }
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        protected JScrollPane createScroller() {
            ...
            list.setBackground(new Color(89,56,46));
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(232,240,214);
        private Color color = new Color(232,240,214);
